...
# Remark
I wasn't able to upload the entire Vue project especially considering the backend Python files and extra Vue config files would already make it too much
